                    ...
                    while ((linea = sr.ReadLine()) != null)
                    {
                        ...
                        foreach (string relevante in condicion)//si encuentra alguna palabra de condicion escribira que existe
                        {
                            ...
                            if (contenido.Contains(uwu))
                            {
                                ...
                                string patron = @"^([a-zA-Z]{2})([\s\p{P}])([a-zA-Z0-9.-]+)([\S+?]{2})([a-zA-Z0-9.-]+)([\s\p{P}]{2,3})([a-zA-Z0-9.-]+)([\S+?]{1,2})([a-zA-Z0-9.-]+)([\S+?]{2,3})?$";
                                if (Regex.IsMatch(contenido, patron))
                                {
                                    Console.WriteLine("La condicion es valida.");
                                }
                                else
                                {
                                    Console.WriteLine("La condicion no es valida.");
                                }
                            }
